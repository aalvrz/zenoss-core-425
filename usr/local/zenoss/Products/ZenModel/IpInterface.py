...
class IpInterface(OSComponent, Layer2Linkable):
    ...
    def index_object(self, idxs=None):
        ...
        if self.macaddress and device:
            if (device.getMacAddressCache().add(self.macaddress)) and \
                            'macAddresses' in self.dmd.global_catalog._catalog.indexes:
    ...
    def unindex_object(self):
        ...
        if device:
            ...
            try: 
                ...
                if 'macAddresses' in self.dmd.global_catalog._catalog.indexes:
                    notify(IndexingEvent(device, idxs=('macAddresses',), update_metadata=False))
            except KeyError:
                pass
