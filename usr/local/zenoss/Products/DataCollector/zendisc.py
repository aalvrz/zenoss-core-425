        ...
        def inner(driver):
            ...
            try:
                ...
                if not self.options.nosnmp:
                    ...
                    snmpCommunities = zProperties.get('zSnmpCommunities', None)
                    if self.options.device:
                        snmpCommunity = zProperties.get('zSnmpCommunity', None)
                        if snmpCommunity:
                            if snmpCommunities:
                                snmpCommunities.insert(0, snmpCommunity)
                            else:
                                snmpCommunities = [snmpCommunity]
