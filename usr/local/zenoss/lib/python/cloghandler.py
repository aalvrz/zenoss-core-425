...
class ConcurrentRotatingFileHandler(BaseRotatingHandler):
    ...
    def __init__(self, filename, mode='a', maxBytes=0, backupCount=0,
        ...
        # Change lock dir path if provided
        dirpath, file_name = os.path.split(os.path.abspath(filename))
        if self._lockdir_path:
            filename = os.path.join(self._lockdir_path, file_name)
